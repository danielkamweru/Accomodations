...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: "Townhouses",
    shortDescription: "An exclusive collection of luxury townhouses set along one of Lavington's most prestigious avenues.",
    longDescription: "Ridgeview Estate represents the pinnacle of luxury living in Lavington. This exclusive development features meticulously designed townhouses that blend contemporary architecture with timeless elegance. Each residence offers expansive living spaces, premium finishes, and private gardens, creating a sanctuary of refined urban living.",
  ...
  },
  {
    ...
    longDescription: "Palm Gardens brings tropical luxury to Lavington with palm-lined gardens and beautifully appointed townhouses. Every detail has been carefully considered to create an oasis of calm in the heart of Nairobi.",
  ...
  },
  {
    ...
    longDescription: "Square Residences is a bold architectural statement in Lavington, featuring contemporary townhouses with expansive floor plans and premium materials. The development is designed for modern families seeking space, style, and security.",
